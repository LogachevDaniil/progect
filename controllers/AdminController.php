...
use app\models\AdminZakazSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * AdminController implements the CRUD actions for Zakaz model.
 */
class AdminController extends Controller
{
    ...
    public function beforeAction($action)
    {
        ...
        //return  Yii::$app->user->identity->isAdmin; // admin - true || false
    ...
    {
        $searchModel = new AdminZakazSearch();
